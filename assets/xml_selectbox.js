...
jQuery(".replace-ac").each(function(n) {
	...
	jQuery(this).children(":selected").each(function(i) {
	...
	var submitHTML = "<input type='hidden' name='" + jQuery(".replace-ac").attr("name") + "' id='ac_value" + n + "' value='" + getSelectedValues(selected[n]) + "' />";
